...
<head>
    ...
    <style type="text/css">
        .paint-card {
            ...
            transition: transform 0.3s ease-in-out; /* Adding a basic transform animation */
        }
        .paint-card:hover {
            transform: translateY(-5px); /* Example of hover animation: move up 5px */
        }
    </style>
</head>
<body>
    ...
    <div class="container p-5">
        ...
        <div class="row">
            <div class="col-md-4">
                <a href="view_doctor.jsp" class="block">
            ...
            <div class="col-md-4">
                <a href="patient.jsp" class="block">
                    <div class="card paint-card">
                        <div class="card-body text-center text-success">
